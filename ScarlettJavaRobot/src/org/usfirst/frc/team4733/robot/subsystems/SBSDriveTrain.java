...
import org.usfirst.frc.team4733.robot.commands.CmdTeleopDrive;
...
public class SBSDriveTrain extends Subsystem {
	...
	public Compressor compressorA = new Compressor(0);
	
	public DoubleSolenoid controllerA = new DoubleSolenoid(3,2);
	...
	public void setPneumatics(double input)
	{
		if(input == 1)
		{
			controllerA.set(DoubleSolenoid.Value.kForward);
		}
		else if(input == 2)
		{
			controllerA.set(DoubleSolenoid.Value.kReverse);
		}
		else if(input == 3)
		{
			controllerA.set(DoubleSolenoid.Value.kOff);
		}
		else if(input == 4)
		{
