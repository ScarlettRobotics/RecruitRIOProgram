...
public class Robot extends TimedRobot {
	...
	public static SBSDriveTrainSample m_sampleDriveTrain;
	...
	public void robotInit() {
		...
		m_sampleDriveTrain = new SBSDriveTrainSample();
		setMotorsInvertedOnBoot();
		m_oi = new OI();
		DriverStation.reportError("Subsystems Setup", false);
	...
	{
		Robot.m_sampleDriveTrain.leftMotors.setInverted(true);
		Robot.m_sampleDriveTrain.rightMotors.setInverted(true);
	}
}
