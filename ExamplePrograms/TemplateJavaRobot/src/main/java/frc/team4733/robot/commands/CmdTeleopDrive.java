...
public class CmdTeleopDrive extends Command {
	...
	protected void execute()
	{
		...
		Robot.m_oi.getXbox().setRumble(GenericHID.RumbleType.kRightRumble, Math.abs(yAccl)/2);
		Robot.m_oi.getXbox().setRumble(GenericHID.RumbleType.kLeftRumble, Math.abs(xAccl)/2);
	...
	protected void end() {
		...
		Robot.m_oi.getXbox().setRumble(GenericHID.RumbleType.kRightRumble, 0);
		Robot.m_oi.getXbox().setRumble(GenericHID.RumbleType.kLeftRumble, 0);
